...
tuning.py
: The script for hyperparameter tuning using Ray Tune.
model.py
: The script defining the LeNet model architecture.
README.md
...
Ray 1.6.0
Results
The LeNet model achieved an accuracy of 70% on the test set after training for 20 epochs with a learning rate of 1.2e-3 and a batch size of 8.
